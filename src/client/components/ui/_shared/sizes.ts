...
export const SIZES: Record<ControlSize, string> = {
  sm: "h-11 gap-1.5 rounded-md px-3 text-xs lg:h-8",
  md: "h-11 gap-2 rounded-md px-4 text-sm lg:h-9",
  lg: "h-11 gap-2 rounded-md px-6 text-sm lg:h-10",
};
...
export const ICON_SIZES: Record<ControlSize, string> = {
  sm: "h-11 w-11 rounded-md lg:h-8 lg:w-8",
  md: "h-11 w-11 rounded-md lg:h-9 lg:w-9",
  lg: "h-11 w-11 rounded-md lg:h-10 lg:w-10",
};
